...
class Conta(Base):
    ...
    conta_dia_fechamento = Column(Integer, nullable=True)
    conta_dia_vencimento = Column(Integer, nullable=True)
    ...
    def __init__(self, nome, tipo, saldo_inicial=0, saldo_disponivel=0, dia_fechamento=None, dia_vencimento=None, ativo=True, usuario_id=None):
        ...
        self.conta_dia_fechamento = dia_fechamento
        self.conta_dia_vencimento = dia_vencimento
